...
- Good homes here: the GPT-4o **extraction result** shape (person/topics/life-events/follow-ups), notification payload types, backup/export JSON schema, tone enums, the topic-expiry state union.
